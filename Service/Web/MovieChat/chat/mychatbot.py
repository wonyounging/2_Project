...
# 전처리 객체 생성
p = Preprocess(word2index_dic='c:/2nd_project/Service/Web/MovieChat/chatbot/data/chatbot_dict.bin',
                userdic='c:/2nd_project/Service/Web/MovieChat/chatbot/data/user_dic.txt')

intent = PredictModel(category='intent', model_name='c:/2nd_project/Service/Web/MovieChat/chatbot/model/question_intent_model.h5', proprocess=p)
emotion = PredictModel(category='emotion', model_name='c:/2nd_project/Service/Web/MovieChat/chatbot/model/question_emotion_model.h5', proprocess=p)
binary = PredictModel(category='binary', model_name='c:/2nd_project/Service/Web/MovieChat/chatbot/model/question_emotion_binary_model.h5', proprocess=p)
trend = PredictModel(category='trend', model_name='c:/2nd_project/Service/Web/MovieChat/chatbot/model/question_trend_model.h5', proprocess=p)
ner = PredictModel(category='ner', model_name='c:/2nd_project/Service/Web/MovieChat/chatbot/model/question_ner_model.h5', proprocess=p)
